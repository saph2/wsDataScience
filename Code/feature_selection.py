...
allFeatures = ['Country','TimeOfDay','OpName','TimeStamp', 'Browser', 'BrowserVer', 'Os', 'OsVer', 'RoleInst', 'Continent', 'Province', 'City' , 'Opid', 'Pid', 'Sid', 'IsFirst', 'Aid', 'Name', 'UrlBase', 'Host']
numberOfClasses=3
